...
void SistemaSolar::update(float t)
{

}

void SistemaSolar::render()
{
...
void SistemaSolar::resize(int w, int h)
{
	glViewport(0, 0, w, h);
	width = w;
	height = h;
...
void SistemaSolar::compileAndLinkShader()
{
	try {
